...
public class CustomWapApplicationServer {
    ...
    public void start() throws IOException {
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            log.info("[CustomWapApplicationServer] started on {} port.", port);

            Socket clientSocket;
            log.info("[CustomWapApplicationServer] waiting for client.");
...
//
//                    // GET /calculate?operand1=1&operator=*&operand2=2 HTTP/1.1
